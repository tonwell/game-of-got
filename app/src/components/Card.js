  ...
  render() {
    return (
      <article onAnimationEnd={this.props.animationEndHandler} className={`characterCard ${this.props.additionalClass}`}>
        ...
        <footer className="seasonsAppearance">featured in {this.props.characterSeasonsAppearance} {this.props.characterSeasonsAppearance.length > 1 ? `seasons` : `season`}</footer>
      </article>
    )
  }
}
